...
async def buy_item_step_2(ctx: StatefulFunction, func_context, attr_1=None, reply_to: list = None):
    ...
    reply_to = push_continuation(
        ...
        "buy_item_step_3",
        ctx.key,
        {"item": item, "amount": amount, "attr_1": attr_1, "total_price": total_price},
    )
...
@user_operator.register
async def bulk_purchase_with_tiers(
    ctx: StatefulFunction, cart: list[str], quantities: list[int], reply_to: list = None
) -> str:
    total_cost = 0
    __loop_index_1 = 0
    ctx.call_remote_async(
        operator_name="user",
        function_name="bulk_purchase_with_tiers_step_2",
        key=ctx.key,
        params=(
            {"__loop_index_1": __loop_index_1, "cart": cart, "quantities": quantities, "total_cost": total_cost},
            None,
            reply_to,
        ),
    )
...
@user_operator.register
async def bulk_purchase_with_tiers_step_2(
    ctx: StatefulFunction, func_context, placeholder_return=None, reply_to: list = None
):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (__loop_index_1, cart, quantities, total_cost) = (
...
async def bulk_purchase_with_tiers_step_3(ctx: StatefulFunction, func_context, attr_8=None, reply_to: list = None):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (__loop_index_1, cart, index, item, quantities, requested_amount, total_cost) = (
        params["__loop_index_1"],
        params["cart"],
        params["index"],
        params["item"],
    ...
    if attr_8 >= requested_amount:
        ...
        ctx.call_remote_async(
            operator_name="user",
            function_name="bulk_purchase_with_tiers_step_4",
            key=ctx.key,
            params=(
                {
                    "__loop_index_1": __loop_index_1,
                    "__loop_index_2": __loop_index_2,
                    "attr_8": attr_8,
                    "cart": cart,
...
@user_operator.register
async def bulk_purchase_with_tiers_step_4(
    ctx: StatefulFunction, func_context, placeholder_return=None, reply_to: list = None
):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (
        ...
        params["__loop_index_1"],
        params["__loop_index_2"],
        params["attr_8"],
        params["cart"],
        params["current_item_cost"],
        params["index"],
        params["item"],
        params["quantities"],
        params["requested_amount"],
    ...
    if __loop_index_2 >= requested_amount + 1:
        ...
        reply_to = push_continuation(
            ...
            reply_to,
            "user",
            "bulk_purchase_with_tiers_step_5",
            ctx.key,
            {
                "quantities": quantities,
                "total_cost": total_cost,
        ...
        ctx.call_remote_async(
            operator_name="item", function_name="update_stock", key=item, params=(-requested_amount, reply_to)
        )
    else:
        unit = __loop_index_2
        __loop_index_2 += 1
        ...
        if unit > 50:
            reply_to = push_continuation(
                ...
                reply_to,
                "user",
                "bulk_purchase_with_tiers_step_6",
                ctx.key,
                {
                    "quantities": quantities,
                    "total_cost": total_cost,
            ...
            reply_to = push_continuation(
                ...
                reply_to,
                "user",
                "bulk_purchase_with_tiers_step_7",
                ctx.key,
                {
                    "quantities": quantities,
                    "total_cost": total_cost,
            ...
            reply_to = push_continuation(
                ...
                reply_to,
                "user",
                "bulk_purchase_with_tiers_step_8",
                ctx.key,
                {
                    "quantities": quantities,
                    "total_cost": total_cost,
...
@user_operator.register
async def bulk_purchase_with_tiers_step_5(
    ctx: StatefulFunction, func_context, placeholder_return=None, reply_to: list = None
):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
...
@user_operator.register
async def type_test(
    ctx: StatefulFunction, hard: list[list[dict[str, int]]], easy: list[list[str]], reply_to: list = None
) -> str:
    temp = easy[0][0]
    reply_to = push_continuation(
        ctx, reply_to, "user", "type_test_step_2", ctx.key, {"hard": hard, "easy": easy, "temp": temp}
    )
...
async def type_test_step_2(ctx: StatefulFunction, func_context, placeholder_return=None, reply_to: list = None):
    ...
    reply_to = push_continuation(
        ...
        "type_test_step_3",
        ctx.key,
        {"attr_4": attr_4, "attr_2": attr_2, "hard": hard, "temp": temp, "attr_3": attr_3, "easy": easy},
    )
...
async def type_test_step_3(ctx: StatefulFunction, func_context, placeholder_return=None, reply_to: list = None):
    params = resolve_context(ctx, func_context)
    (attr_2, attr_3, attr_4, easy, hard, temp) = (
        params["attr_2"],
        params["attr_3"],
        params["attr_4"],
        params["easy"],
...
async def type_test_step_4(ctx: StatefulFunction, func_context, placeholder_return=None, reply_to: list = None):
    params = resolve_context(ctx, func_context)
    (attr_2, attr_3, attr_4, easy, hard, temp, temp3) = (
        params["attr_2"],
        params["attr_3"],
        params["attr_4"],
        params["easy"],
...
async def type_test_step_6(ctx: StatefulFunction, func_context, placeholder_return=None, reply_to: list = None):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (attr_2, attr_3, attr_4, easy, hard, temp, temp3, temp4) = (
        params["attr_2"],
        params["attr_3"],
        params["attr_4"],
        params["easy"],
...
async def type_test_step_7(ctx: StatefulFunction, func_context, stock_val=None, reply_to: list = None):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (attr_2, attr_3, attr_4, attr_9, easy, hard, temp, temp3, temp4) = (
        params["attr_2"],
        params["attr_3"],
        params["attr_4"],
        params["attr_9"],
...
async def type_test_step_8(ctx: StatefulFunction, func_context, stock=None, reply_to: list = None):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (attr_12, attr_2, attr_3, attr_4, attr_9, easy, hard, lst, something, stock_val, temp, temp3, temp4) = (
        params["attr_12"],
        params["attr_2"],
        params["attr_3"],
        params["attr_4"],
