...
async def buy_item_step_2(ctx: StatefulFunction, func_context, attr_1 = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'buy_item_step_3', ctx.key, {'attr_1': attr_1, 'amount': amount, 'item': item, 'total_price': total_price})
    ctx.put(state)
...
async def drain_stock(ctx: StatefulFunction, item: str, reply_to: list = None) -> int:
    total = 0
    reply_to = push_continuation(ctx, reply_to, 'user', 'drain_stock_step_2', ctx.key, {'item': item, 'total': total})
...
async def drain_stock_step_3(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    if 0 < (attr_2 - 1):
        reply_to = push_continuation(ctx, reply_to, 'user', 'drain_stock_step_4', ctx.key, {'attr_2': attr_2, 'item': item, 'total': total})
...
async def drain_stock_step_4(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    (attr_2, item, total) = (params['attr_2'], params['item'], params['total'])
    total += 1
    reply_to = push_continuation(ctx, reply_to, 'user', 'drain_stock_step_3', ctx.key, {'attr_2': attr_2, 'item': item, 'total': total})
    ctx.call_remote_async(operator_name = 'item', function_name = 'get_stock', key = item, params = (reply_to,))
...
async def bulk_purchase_with_tiers_step_2(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    if __loop_index_1 >= len(cart):
        ...
        reply_to = push_continuation(ctx, reply_to, 'user', 'bulk_purchase_with_tiers_step_3', ctx.key, {'cart': cart, 'total_cost': total_cost, '__loop_index_1': __loop_index_1, 'item': item, 'requested_amount': requested_amount, 'index': index, 'quantities': quantities})
        ctx.put(state)
        ctx.call_remote_async(operator_name = 'item', function_name = 'get_stock', key = item, params = (reply_to,))
...
async def bulk_purchase_with_tiers_step_4(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    if __loop_index_2 >= requested_amount + 1:
        ...
        reply_to = push_continuation(ctx, reply_to, 'user', 'bulk_purchase_with_tiers_step_5', ctx.key, {'cart': cart, 'total_cost': total_cost, '__loop_index_1': __loop_index_1, 'item': item, 'attr_7': attr_7, 'requested_amount': requested_amount, 'current_item_cost': current_item_cost, '__loop_index_2': __loop_index_2, 'index': index, 'quantities': quantities})
        ctx.put(state)
        ...
        __loop_index_2 += 1
        if unit > 50:
            reply_to = push_continuation(ctx, reply_to, 'user', 'bulk_purchase_with_tiers_step_6', ctx.key, {'cart': cart, 'total_cost': total_cost, '__loop_index_1': __loop_index_1, 'item': item, 'unit': unit, 'attr_7': attr_7, 'requested_amount': requested_amount, 'current_item_cost': current_item_cost, '__loop_index_2': __loop_index_2, 'index': index, 'quantities': quantities})
            ctx.put(state)
            ctx.call_remote_async(operator_name = 'item', function_name = 'get_price', key = item, params = (reply_to,))
        elif unit > 10:
...
async def type_test(ctx: StatefulFunction, hard: list[list[dict[str, int]]], easy: list[list[str]], reply_to: list = None) -> str:
    temp = easy[0][0]
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_2', ctx.key, {'hard': hard, 'easy': easy, 'temp': temp})
...
async def type_test_step_2(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_3', ctx.key, {'temp': temp, 'hard': hard, 'attr_4': attr_4, 'attr_3': attr_3, 'easy': easy, 'attr_2': attr_2})
...
async def type_test_step_3(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    temp3 = easy[0][0]
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_4', ctx.key, {'temp3': temp3, 'temp': temp, 'hard': hard, 'attr_4': attr_4, 'attr_3': attr_3, 'easy': easy, 'attr_2': attr_2})
...
async def type_test_step_4(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_5', ctx.key, {'temp3': temp3, 'temp': temp, 'hard': hard, 'attr_4': attr_4, 'attr_3': attr_3, 'easy': easy, 'attr_2': attr_2})
...
async def type_test_step_5(ctx: StatefulFunction, func_context, temp4 = None, reply_to: list = None):
    params = resolve_context(ctx, func_context)
    (attr_2, attr_3, attr_4, easy, hard, temp, temp3) = (params['attr_2'], params['attr_3'], params['attr_4'], params['easy'], params['hard'], params['temp'], params['temp3'])
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_6', ctx.key, {'temp3': temp3, 'temp': temp, 'hard': hard, 'attr_4': attr_4, 'attr_3': attr_3, 'temp4': temp4, 'easy': easy, 'attr_2': attr_2})
...
async def type_test_step_6(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_7', ctx.key, {'temp3': temp3, 'temp': temp, 'hard': hard, 'attr_4': attr_4, 'attr_3': attr_3, 'temp4': temp4, 'attr_9': attr_9, 'easy': easy, 'attr_2': attr_2})
    ctx.put(state)
...
async def type_test_step_7(ctx: StatefulFunction, func_context, stock_val = None, reply_to: list = None):
    ...
    attr_12 = lst[0]
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_8', ctx.key, {'something': something, 'temp3': temp3, 'temp': temp, 'hard': hard, 'attr_4': attr_4, 'lst': lst, 'attr_12': attr_12, 'attr_3': attr_3, 'temp4': temp4, 'attr_9': attr_9, 'easy': easy, 'stock_val': stock_val, 'attr_2': attr_2})
    ctx.put(state)
...
async def type_test_step_8(ctx: StatefulFunction, func_context, stock = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_9', ctx.key, {'something': something, 'temp3': temp3, 'temp': temp, 'hard': hard, 'attr_4': attr_4, 'lst': lst, 'attr_12': attr_12, 'temp5': temp5, 'attr_3': attr_3, 'temp4': temp4, 'attr_9': attr_9, 'easy': easy, 'stock': stock, 'stock_val': stock_val, 'attr_2': attr_2})
    ctx.put(state)
