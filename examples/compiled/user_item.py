...
async def buy_item_step_2(ctx: StatefulFunction, func_context, attr_1 = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'buy_item_step_3', ctx.key, {'total_price': total_price, 'amount': amount, 'item': item, 'attr_1': attr_1})
...
async def drain_stock(ctx: StatefulFunction, item: str, reply_to: list = None) -> int:
    total = 0
    reply_to = push_continuation(ctx, reply_to, 'user', 'drain_stock_step_2', ctx.key, {'total': total, 'item': item})
    ctx.call_remote_async(operator_name = 'item', function_name = 'get_stock', key = item, params = (reply_to,))

@user_operator.register
async def drain_stock_step_2(ctx: StatefulFunction, func_context, attr_2 = None, reply_to: list = None):
    params = resolve_context(ctx, func_context)
    (item, total) = (params['item'], params['total'])
    ctx.call_remote_async(operator_name = 'user', function_name = 'drain_stock_step_3', key = ctx.key, params = ({'attr_2': attr_2, 'item': item, 'total': total}, None, reply_to))

@user_operator.register
async def drain_stock_step_3(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    params = resolve_context(ctx, func_context)
    (attr_2, item, total) = (params['attr_2'], params['item'], params['total'])
    if 0 < (attr_2 - 1):
        reply_to = push_continuation(ctx, reply_to, 'user', 'drain_stock_step_4', ctx.key, {'total': total, 'attr_2': attr_2, 'item': item})
...
@user_operator.register
async def drain_stock_step_4(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    params = resolve_context(ctx, func_context)
    (attr_2, item, total) = (params['attr_2'], params['item'], params['total'])
    total += 1
    reply_to = push_continuation(ctx, reply_to, 'user', 'drain_stock_step_3', ctx.key, {'total': total, 'attr_2': attr_2, 'item': item})
    ctx.call_remote_async(operator_name = 'item', function_name = 'get_stock', key = item, params = (reply_to,))
...
async def bulk_purchase_with_tiers_step_2(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    if __loop_index_1 >= len(cart):
        ...
        reply_to = push_continuation(ctx, reply_to, 'user', 'bulk_purchase_with_tiers_step_3', ctx.key, {'cart': cart, 'quantities': quantities, 'index': index, 'total_cost': total_cost, '__loop_index_1': __loop_index_1, 'item': item, 'requested_amount': requested_amount})
        ctx.put(state)
        ctx.call_remote_async(operator_name = 'item', function_name = 'get_stock', key = item, params = (reply_to,))

@user_operator.register
async def bulk_purchase_with_tiers_step_3(ctx: StatefulFunction, func_context, attr_7 = None, reply_to: list = None):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    ...
    if attr_7 >= requested_amount:
        current_item_cost = 0
        __loop_index_2 = 1
        ctx.call_remote_async(operator_name = 'user', function_name = 'bulk_purchase_with_tiers_step_4', key = ctx.key, params = ({'__loop_index_1': __loop_index_1, '__loop_index_2': __loop_index_2, 'attr_7': attr_7, 'cart': cart, 'current_item_cost': current_item_cost, 'index': index, 'item': item, 'quantities': quantities, 'requested_amount': requested_amount, 'total_cost': total_cost}, None, reply_to))
    else:
        logging.warning(f"Skipping {item} due to low stock.")
        ctx.put(state)
        ctx.call_remote_async(operator_name = 'user', function_name = 'bulk_purchase_with_tiers_step_2', key = ctx.key, params = ({'__loop_index_1': __loop_index_1, 'attr_7': attr_7, 'cart': cart, 'index': index, 'item': item, 'quantities': quantities, 'requested_amount': requested_amount, 'total_cost': total_cost}, None, reply_to))

@user_operator.register
async def bulk_purchase_with_tiers_step_4(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (__loop_index_1, __loop_index_2, attr_7, cart, current_item_cost, index, item, quantities, requested_amount, total_cost) = (params['__loop_index_1'], params['__loop_index_2'], params['attr_7'], params['cart'], params['current_item_cost'], params['index'], params['item'], params['quantities'], params['requested_amount'], params['total_cost'])
    if __loop_index_2 >= requested_amount + 1:
        ...
        reply_to = push_continuation(ctx, reply_to, 'user', 'bulk_purchase_with_tiers_step_5', ctx.key, {'cart': cart, 'quantities': quantities, 'index': index, 'current_item_cost': current_item_cost, '__loop_index_2': __loop_index_2, 'total_cost': total_cost, 'attr_7': attr_7, '__loop_index_1': __loop_index_1, 'item': item, 'requested_amount': requested_amount})
        ctx.call_remote_async(operator_name = 'item', function_name = 'update_stock', key = item, params = (-requested_amount, reply_to))
    else:
        unit = __loop_index_2
        __loop_index_2 += 1
        if unit > 50:
            reply_to = push_continuation(ctx, reply_to, 'user', 'bulk_purchase_with_tiers_step_6', ctx.key, {'cart': cart, 'quantities': quantities, 'index': index, 'current_item_cost': current_item_cost, '__loop_index_2': __loop_index_2, 'total_cost': total_cost, 'attr_7': attr_7, '__loop_index_1': __loop_index_1, 'item': item, 'requested_amount': requested_amount, 'unit': unit})
            ctx.call_remote_async(operator_name = 'item', function_name = 'get_price', key = item, params = (reply_to,))
        elif unit > 10:
...
async def bulk_purchase_with_tiers_step_5(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    for copy in range(requested_amount):
        state['myitems'].append(item)
    ctx.put(state)
    ctx.call_remote_async(operator_name = 'user', function_name = 'bulk_purchase_with_tiers_step_2', key = ctx.key, params = ({'__loop_index_1': __loop_index_1, '__loop_index_2': __loop_index_2, 'attr_7': attr_7, 'cart': cart, 'copy': copy, 'current_item_cost': current_item_cost, 'index': index, 'item': item, 'quantities': quantities, 'requested_amount': requested_amount, 'total_cost': total_cost}, None, reply_to))

@user_operator.register
async def bulk_purchase_with_tiers_step_6(ctx: StatefulFunction, func_context, attr_1 = None, reply_to: list = None):
    state = ctx.get()
    params = resolve_context(ctx, func_context)
    (__loop_index_1, __loop_index_2, attr_7, cart, current_item_cost, index, item, quantities, requested_amount, total_cost, unit) = (params['__loop_index_1'], params['__loop_index_2'], params['attr_7'], params['cart'], params['current_item_cost'], params['index'], params['item'], params['quantities'], params['requested_amount'], params['total_cost'], params['unit'])
    current_item_cost = current_item_cost + int(attr_1 * 0.8)
    ctx.put(state)
    ctx.call_remote_async(operator_name = 'user', function_name = 'bulk_purchase_with_tiers_step_4', key = ctx.key, params = ({'__loop_index_1': __loop_index_1, '__loop_index_2': __loop_index_2, 'attr_1': attr_1, 'attr_7': attr_7, 'cart': cart, 'current_item_cost': current_item_cost, 'index': index, 'item': item, 'quantities': quantities, 'requested_amount': requested_amount, 'total_cost': total_cost, 'unit': unit}, None, reply_to))
...
async def bulk_purchase_with_tiers_step_7(ctx: StatefulFunction, func_context, attr_2 = None, reply_to: list = None):
    ...
    ctx.put(state)
    ctx.call_remote_async(operator_name = 'user', function_name = 'bulk_purchase_with_tiers_step_4', key = ctx.key, params = ({'__loop_index_1': __loop_index_1, '__loop_index_2': __loop_index_2, 'attr_2': attr_2, 'attr_7': attr_7, 'cart': cart, 'current_item_cost': current_item_cost, 'index': index, 'item': item, 'quantities': quantities, 'requested_amount': requested_amount, 'total_cost': total_cost, 'unit': unit}, None, reply_to))
...
async def bulk_purchase_with_tiers_step_8(ctx: StatefulFunction, func_context, attr_3 = None, reply_to: list = None):
    ...
    ctx.put(state)
    ctx.call_remote_async(operator_name = 'user', function_name = 'bulk_purchase_with_tiers_step_4', key = ctx.key, params = ({'__loop_index_1': __loop_index_1, '__loop_index_2': __loop_index_2, 'attr_3': attr_3, 'attr_7': attr_7, 'cart': cart, 'current_item_cost': current_item_cost, 'index': index, 'item': item, 'quantities': quantities, 'requested_amount': requested_amount, 'total_cost': total_cost, 'unit': unit}, None, reply_to))
...
async def get_first_item(ctx: StatefulFunction, reply_to: list = None) -> str:
    reply_to = push_continuation(ctx, reply_to, 'user', 'get_first_item_step_2', ctx.key, {})
    ctx.call_remote_async(operator_name = 'item', function_name = 'create', key = "test", params = ("test", 10, reply_to))

@user_operator.register
async def get_first_item_step_2(ctx: StatefulFunction, func_context, attr_1 = None, reply_to: list = None):
    state = ctx.get()
    state['myitems'].append(attr_1)
...
async def type_test(ctx: StatefulFunction, hard: list[list[dict[str, int]]], easy: list[list[str]], reply_to: list = None) -> str:
    temp = easy[0][0]
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_2', ctx.key, {'easy': easy, 'temp': temp, 'hard': hard})
...
async def type_test_step_2(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_3', ctx.key, {'attr_4': attr_4, 'temp': temp, 'attr_3': attr_3, 'hard': hard, 'easy': easy, 'attr_2': attr_2})
...
async def type_test_step_3(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    temp3 = easy[0][0]
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_4', ctx.key, {'attr_4': attr_4, 'temp': temp, 'attr_3': attr_3, 'hard': hard, 'easy': easy, 'attr_2': attr_2, 'temp3': temp3})
...
async def type_test_step_4(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_5', ctx.key, {'attr_4': attr_4, 'temp': temp, 'attr_3': attr_3, 'hard': hard, 'easy': easy, 'attr_2': attr_2, 'temp3': temp3})
...
async def type_test_step_5(ctx: StatefulFunction, func_context, temp4 = None, reply_to: list = None):
    params = resolve_context(ctx, func_context)
    (attr_2, attr_3, attr_4, easy, hard, temp, temp3) = (params['attr_2'], params['attr_3'], params['attr_4'], params['easy'], params['hard'], params['temp'], params['temp3'])
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_6', ctx.key, {'attr_4': attr_4, 'temp': temp, 'attr_3': attr_3, 'hard': hard, 'easy': easy, 'temp4': temp4, 'attr_2': attr_2, 'temp3': temp3})
...
async def type_test_step_6(ctx: StatefulFunction, func_context, placeholder_return = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_7', ctx.key, {'attr_4': attr_4, 'temp': temp, 'attr_3': attr_3, 'attr_9': attr_9, 'hard': hard, 'easy': easy, 'temp4': temp4, 'attr_2': attr_2, 'temp3': temp3})
...
async def type_test_step_7(ctx: StatefulFunction, func_context, stock_val = None, reply_to: list = None):
    ...
    attr_12 = lst[0]
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_8', ctx.key, {'attr_4': attr_4, 'temp': temp, 'attr_3': attr_3, 'attr_9': attr_9, 'hard': hard, 'lst': lst, 'stock_val': stock_val, 'easy': easy, 'temp4': temp4, 'attr_12': attr_12, 'attr_2': attr_2, 'temp3': temp3, 'something': something})
...
async def type_test_step_8(ctx: StatefulFunction, func_context, stock = None, reply_to: list = None):
    ...
    reply_to = push_continuation(ctx, reply_to, 'user', 'type_test_step_9', ctx.key, {'attr_4': attr_4, 'temp': temp, 'attr_3': attr_3, 'attr_9': attr_9, 'hard': hard, 'lst': lst, 'stock_val': stock_val, 'easy': easy, 'temp4': temp4, 'attr_12': attr_12, 'temp5': temp5, 'attr_2': attr_2, 'temp3': temp3, 'something': something, 'stock': stock})
