...
Compiler for the Styx embedded DSL in Python
...
```python
from styx_compiler import __version__

print(f"styx_compiler version is { __version__ }")
```
...
This will let you do `pip install styx-compiler`.
